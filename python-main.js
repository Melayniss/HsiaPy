...
function web_editor(config) {
    ...
    // This function describes what to do when the Cloud-download button is clicked.
    function doDownload() {
    }
	
	// This function describes what to do when the Cloud-Upload button is clicked.
    function doUpload() {
	...
	//This function describes what to do when the saveHex button is clicked.
	function doSaveHex(){
    ...
    // This function describes what to do when the savePy button is clicked.
    function doSavePy() {
    ...
    function doBlockly() {
        ...
        if(blockly.is(':visible')) {
            ...
            $('#editor').attr('title', '代码编辑器在可视化编程时是只读的状态.');
            $("#command-snippet").off('click');
            $("#command-snippet").click(function () {
        ...
        $(".blocklySvg").css("height", $(".blocklySvg").parent.height());
    }
    ...
    function setupButtons() {
		...
		$("#command-Upload").click(function () {
            doUpload();
        });
		$("#command-saveHex").click(function () {
            doSaveHex();
        });
        $("#command-savePy").click(function () {
            doSavePy();
        });
